...
$(document).ready(function(){
    ...
    var scrollPage = function(page) {
        var selector_str = ".menu a[href='#"+page+"']:first"
        console.log(selector_str)
        var menu_elem = $( selector_str )
    ...
    $(".menu ul li a").click(function(){
        ...
        // Check if we scroll this page or go to another.
    ...
    if (window.location.hash) {
        scrollPage(window.location.hash.substring(1));
    } else {
        scrollPage("home")
    }
